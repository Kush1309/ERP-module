  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div>
          <h2 className="text-lg font-semibold text-ink-900 mb-3">Communication</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <Link to="/messages" className="block p-4 rounded-xl border border-ink-200 bg-white hover:border-brand-300 hover:shadow-sm transition-all text-left">
              <h3 className="font-medium text-ink-900">Direct Messages</h3>
              <p className="mt-1 text-sm text-ink-500">Communicate securely with teachers, parents, and students.</p>
            </Link>
          </div>
        </div>
        <div>
          <h2 className="text-lg font-semibold text-ink-900 mb-3">Academics</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <Link to="/homework" className="block p-4 rounded-xl border border-ink-200 bg-white hover:border-brand-300 hover:shadow-sm transition-all text-left">
        ...
        <div>
          <h2 className="text-lg font-semibold text-ink-900 mb-3">Human Resources</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <Link to="/leaves" className="block p-4 rounded-xl border border-ink-200 bg-white hover:border-brand-300 hover:shadow-sm transition-all text-left">
              <h3 className="font-medium text-ink-900">Leave Management</h3>
              <p className="mt-1 text-sm text-ink-500">Approve and track leave requests.</p>
            </Link>
          </div>
        </div>
        <div>
          <h2 className="text-lg font-semibold text-ink-900 mb-3">Library Management</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <Link to="/library" className="block p-4 rounded-xl border border-ink-200 bg-white hover:border-brand-300 hover:shadow-sm transition-all text-left">
              <h3 className="font-medium text-ink-900">Library</h3>
              <p className="mt-1 text-sm text-ink-500">Manage catalogues, checkout books, and enforce return states.</p>
            </Link>
          </div>
        </div>
        <div>
          <h2 className="text-lg font-semibold text-ink-900 mb-3">Financial Management</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <Link to="/fees" className="block p-4 rounded-xl border border-ink-200 bg-white hover:border-brand-300 hover:shadow-sm transition-all text-left">
              <h3 className="font-medium text-ink-900">Fee Management</h3>
              <p className="mt-1 text-sm text-ink-500">Manage fee structures, records, and process payments.</p>
            </Link>
          </div>
        </div>
      </div>
