...
import { getStudentNotices } from '../../services/studentNoticeApi';
...
export default function StudentNoticesPage() {
    ...
    const fetchNotices = useCallback(async () => {
        try {
            setLoading(true);
            const data = await getStudentNotices(query);
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-7xl">
            <div className="mb-8">
                <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Student Noticeboard</h1>
                <p className="mt-2 text-gray-600">Important academic and school announcements.</p>
            </div>
